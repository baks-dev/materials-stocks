...
executeFunc(function materialStocsPurchase()
{
    ...
    document.getElementById(ChangePurchaseForm.name + "_purchase").addEventListener("click", function(event)
    {
    ...
    await fetch(forms.action, {
        ...
        }).then((data) =>
        {
            ...
            if(data)
            {
                ...
                {
                    /** Сбрасываем ошибки валидации */
                    preOffer.querySelectorAll(".is-invalid").forEach((el) =>
                    {
                        el.classList.remove("is-invalid");
                    });
                    preOffer.querySelectorAll(".invalid-feedback").forEach((el) =>
                    {
                        el.remove();
                    });
        ...
        }).then((data) =>
        {
            ...
            if(data)
            {
                ...
                if(preVariation)
                {
                    ...
                    preVariation.querySelectorAll(".is-invalid").forEach((el) =>
                    {
                        el.classList.remove("is-invalid");
                    });
                    preVariation.querySelectorAll(".invalid-feedback").forEach((el) =>
                    {
                        el.remove();
                    });
    ...
    await fetch(forms.action, {
        ...
        }).then((data) =>
        {
            ...
            if(data)
            {
                ...
                if(preModification)
                {
                    preModification.querySelectorAll(".is-invalid").forEach((el) =>
                    {
                        el.classList.remove("is-invalid");
                    });
                    preModification.querySelectorAll(".invalid-feedback").forEach((el) =>
                    {
                        el.remove();
                    });
