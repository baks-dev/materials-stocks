...
//
//     /* Change MATERIAL */
//     let object_material = document.getElementById('incoming_material_stock_form_preProduct');
//
//
//
//     if (object_material) {
...
function addProductIncoming()
{
    ...
    let $preMaterial = document.getElementById('incoming_material_stock_form_preProduct');
