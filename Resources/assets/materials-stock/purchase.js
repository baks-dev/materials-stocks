...
//{
//
//    var object_material = document.getElementById('purchase_material_stock_form_preProduct');
//
//    if(object_material)
//    {
//
//        object_material.addEventListener('change', changeObjectProduct, false);
//
//        let $addButtonStock = document.getElementById('purchase_material_stock_form_addPurchase');
//
...
//        // });
//
//        document.getElementById('purchase_material_stock_form_purchase')
...
//            });
//
//        document.getElementById("purchase_material_stock_form_preTotal")
...
//
//
//        document.getElementById("purchase_material_stock_form_number")
//            .addEventListener("keydown", function(event)
//            {
//
//                if(event.key === "Enter")
...
//                    event.preventDefault();
//
//                    var input_preMaterial = document.getElementById('purchase_material_stock_form_select2');
//
//                    if(input_preProduct)
//                    {
//                        document.getElementById('purchase_material_stock_form_select2').click();
//
//                    }
//                }
//            });
...
executeFunc(function _______________materialStocsPurchase()
{
    ...
    await fetch(forms.action, {
        ...
        .then((data) =>
        {
            ...
            if(data)
            {
                ...
                let preMaterial = result.getElementById('preProduct');
...
/* Change MATERIAL */
//object_material = document.getElementById('purchase_material_stock_form_preProduct');
...
//     {
//         let object_material = document.getElementById('purchase_material_stock_form_preProduct');
//
//         if (object_material) {
//             object_material.addEventListener('change', changeObjectProduct, false);
//
...
function _____changeObjectMaterial()
{
    ...
    let replaceId = 'purchase_material_stock_form_preOffer';
    ...
    requestModalName.addEventListener("readystatechange", function()
    {
        ...
        if(requestModalName.readyState === 4 && requestModalName.status === 200)
        {
            ...
            if(replacer.tagName === 'SELECT')
            {
                ...
                /** Событие на изменение торгового предложения */
                let offerChange = document.getElementById('purchase_material_stock_form_preOffer');
...
function _____changeObjectOffer()
{
    ...
    let replaceId = 'purchase_material_stock_form_preVariation';
    ...
    requestModalName.addEventListener("readystatechange", function()
    {
        ...
        if(requestModalName.readyState === 4 && requestModalName.status === 200)
        {
            ...
            if(replacer.tagName === 'SELECT')
            {
                ...
                let offerVariation = document.getElementById('purchase_material_stock_form_preVariation');
...
function _____changeObjectVariation()
{
    ...
    let replaceId = 'purchase_material_stock_form_preModification';
    ...
    requestModalName.addEventListener("readystatechange", function()
    {
        ...
        if(requestModalName.readyState === 4 && requestModalName.status === 200)
        {
            ...
            /** Событие на изменение множественного варианта предложения */
            let offerModification = document.getElementById('purchase_material_stock_form_preModification');
            ...
            if(offerModification)
            {
                ...
                offerModification.addEventListener("change", (event) =>
                {
                    ...
                    {
                        document.getElementById('purchase_material_stock_form_preTotal').focus();
                    }, 100);
...
function addProductPurchase()
{
    ...
    let $preMaterial = document.getElementById(ChangePurchaseForm.name + '_preProduct');
    ...
    $material.value = $preProduct.value;

    let materialIndex = $preProduct.selectedIndex;
    let $materialName = $preProduct.options[materialIndex].textContent;
    ...
    setTimeout(function init_TQCmNQtx()
    {
        ...
        var input_preMaterial = document.getElementById(ChangePurchaseForm.name + '_preProduct');
